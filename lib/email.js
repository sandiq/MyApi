...
const mailer = {
    inboxGmailRegist: (email, codeverify) => {
        ...
        <div
            ...
            <h3>Welcome to DeskusApis - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285346923840">WhatsApp</a></span></span>
      ...
      `;
          ...
          let mailOptions = {
              from: '"DeskusApis" <no-reply@gmail.com>',
              to: email,
              subject: `Verify Email - DeskusApis`,
              html: inboxGmail,
          };
